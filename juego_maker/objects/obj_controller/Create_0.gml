...
var number_of_tiles = (sprite_get_number(spr_card) - 1) * 2;
var tiles;
...
{
	//positioning
	xx =  sprite_width / 2 + spacing + (sprite_width + spacing)  * (i mod tiles_per_row);
	yy = sprite_height / 2 + spacing + (sprite_height + spacing) * floor(i / tiles_per_row);
